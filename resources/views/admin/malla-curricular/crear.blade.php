    ...
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        <div class="d-flex align-items-center flex-wrap mr-1">
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                <h5 class="text-dark font-weight-bold my-1 mr-5"> <i class="fa fa-edit"></i> REGISTRAR</h5>
            </div>
        </div>
    ...
    <div class="card card-custom">
        <div class="card-header py-3">
            <div class="card-title">
                ...
                <h3 class="card-label">ASIGNAR PUNTAJE AL CURSO</h3>
            </div>
        </div>
        <div class="card-body">
            <style>
            ...
            <form action="{{route('admin_store_macurricular')}}" method="post" autocomplete="off">
                @csrf
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <select id="idcurso" name="idcurso" class="form-control selectpicker {{ $errors->first('idcurso') ? 'error-select' : '' }}" data-live-search="true">
                                ...
                                @foreach ($cursos as $item)
                                    <option value="{{ $item->idcurso }}" {{ old('idcurso') == $item->idcurso ? "selected" : "" }}>
                                        {{ $item->titulo }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-3">
                        <div class="form-group mb-4">
                            ...
                            <input type="number" name="examen_final" class="form-control {{ $errors->first('examen_final') ? 'is-invalid' : '' }}"
                                placeholder="Ingrese porcentaje examen final" value="{{ old('examen_final') }}">
                    ...
                    <div class="col-md-3">
                        <div class="form-group mb-4">
                            ...
                            <input type="number" name="trabajo_final" class="form-control {{ $errors->first('trabajo_final') ? 'is-invalid' : '' }}"
                                placeholder="Ingrese porcentaje trabajo final" value="{{ old('trabajo_final') }}">
